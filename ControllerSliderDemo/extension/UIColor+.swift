...
extension UIColor {
    ...
    class func randomBGColor() -> UIColor {
        
        let colorArr: Array<UInt> = [0xfbf9f5, 0xf4f7fb, 0xfbf6f5, 0xf6fcf7, 0xf1f8f9]
        let index:Int = Int(arc4random() % 5)
        return UIColor.init(valueRGB: UInt(colorArr[index]))
    }
